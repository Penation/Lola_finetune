...
class StateEncoding(IntEnum):
    ...
    DUAL_POS_QUAT = 5 # dual arm: EEF XYZ (3) + Quaternion (4) + Gripper Open/Close (1)
    # fmt: on
...
class ActionEncoding(IntEnum):
    ...
    # fmt: on
    DUAL_EEF_POS = 5 # dual arm: # EEF Delta XYZ (3) + Roll-Pitch-Yaw (3) + Gripper Open/Close (1)
...
OXE_DATASET_CONFIGS = {
    "agibot_alpha":{
        ...
        "state_obs_keys": ["all"],
        "state_encoding": StateEncoding.DUAL_POS_QUAT,
